...
def main():
    ...
    hostname_group.add_argument("--hostnames", help="Comma-separated list of target device hostnames/IPs")
    hostname_group.add_argument("--hostname", help="Single hostname or comma-separated list (alias for --hostnames)")
